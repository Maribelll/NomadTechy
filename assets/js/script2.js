...
function start1() {
    ...
    serv1.style.backgroundColor = "#F8F8F8";
...
function start2() {
    ...
    var serv55 = document.getElementById("serv55");
    serv5.style.backgroundColor = "#FFFFFF";
    serv2.style.backgroundColor = "#F8F8F8";
...
function start3() {
    ...
    var serv5 = document.getElementById("serv5");
    var serv55 = document.getElementById("serv55");
    serv3.style.backgroundColor = "#F8F8F8";
    serv1.style.backgroundColor = "#FFFFFF";
    serv2.style.backgroundColor = "#FFFFFF";
    serv4.style.backgroundColor = "#FFFFFF";
    serv5.style.backgroundColor = "#FFFFFF";
...
function start4() {
    ...
    var serv5 = document.getElementById("serv5");
    var serv55 = document.getElementById("serv55");
    serv4.style.backgroundColor = "#F8F8F8";
    serv1.style.backgroundColor = "#FFFFFF";
    serv2.style.backgroundColor = "#FFFFFF";
    serv3.style.backgroundColor = "#FFFFFF";
    serv5.style.backgroundColor = "#FFFFFF";
...
function start5() {
    ...
    var serv5 = document.getElementById("serv5");
    var serv55 = document.getElementById("serv55");
    serv5.style.backgroundColor = "#F8F8F8";
    serv1.style.backgroundColor = "#FFFFFF";
    serv2.style.backgroundColor = "#FFFFFF";
    serv4.style.backgroundColor = "#FFFFFF";
    serv3.style.backgroundColor = "#FFFFFF";
...
function start55() {
    ...
    var serv5 = document.getElementById("serv5");
    var serv55 = document.getElementById("serv55");
    serv55.style.backgroundColor = "#F8F8F8";
    serv1.style.backgroundColor = "#FFFFFF";
    serv2.style.backgroundColor = "#FFFFFF";
    serv4.style.backgroundColor = "#FFFFFF";
    serv3.style.backgroundColor = "#FFFFFF";
